...
namespace Library {
    ...
    public partial class LMSDataSet : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public BooksRow AddBooksRow(int BookID, string Title, string Author, string Category, string AvailabilityStatus, int PublishedYear) {
        ...
        public partial class BooksRow : global::System.Data.DataRow {
            ...
            public string AvailabilityStatus {
                get {
                    return ((string)(this[this.tableBooks.AvailabilityStatusColumn]));
                }
                set {
                    this[this.tableBooks.AvailabilityStatusColumn] = value;
                }
            }
...
namespace Library.LMSDataSetTableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Books] WHERE (([BookID] = @Original_BookID) AND ([Title] = @Original_Title) AND ((@IsNull_Author = 1 AND [Author] IS NULL) OR ([Author] = @Original_Author)) AND ((@IsNull_PublishedYear = 1 AND [PublishedYear] IS NULL) OR ([PublishedYear] = @Original_PublishedYear)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Books] ([BookID], [Title], [Author], [Category], [AvailabilityStatus], [PublishedYear]) VALUES (@BookID, @Title, @Author, @Category, @AvailabilityStatus, @PublishedYear);
SELECT BookID, Title, Author, Category, AvailabilityStatus, PublishedYear FROM Books WHERE (BookID = @BookID)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@AvailabilityStatus", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "AvailabilityStatus", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Books] SET [BookID] = @BookID, [Title] = @Title, [Author] = @Author, [Category] = @Category, [AvailabilityStatus] = @AvailabilityStatus, [PublishedYear] = @PublishedYear WHERE (([BookID] = @Original_BookID) AND ([Title] = @Original_Title) AND ((@IsNull_Author = 1 AND [Author] IS NULL) OR ([Author] = @Original_Author)) AND ((@IsNull_PublishedYear = 1 AND [PublishedYear] IS NULL) OR ([PublishedYear] = @Original_PublishedYear)));
SELECT BookID, Title, Author, Category, AvailabilityStatus, PublishedYear FROM Books WHERE (BookID = @BookID)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@AvailabilityStatus", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "AvailabilityStatus", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Library.Properties.Settings.Default.LMSConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT BookID, Title, Author, Category, AvailabilityStatus, PublishedYear FROM db" +
                "o.Books";
        ...
        public virtual int Delete(int Original_BookID, string Original_Title, string Original_Author, global::System.Nullable<int> Original_PublishedYear) {
            ...
            if ((Original_PublishedYear.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[5].Value = ((int)(Original_PublishedYear.Value));
            }
            else {
        ...
        public virtual int Insert(int BookID, string Title, string Author, string Category, string AvailabilityStatus, global::System.Nullable<int> PublishedYear) {
            ...
            if ((AvailabilityStatus == null)) {
                throw new global::System.ArgumentNullException("AvailabilityStatus");
            }
            else {
                this.Adapter.InsertCommand.Parameters[4].Value = ((string)(AvailabilityStatus));
            }
            if ((PublishedYear.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[5].Value = ((int)(PublishedYear.Value));
            }
            else {
        ...
        public virtual int Update(int BookID, string Title, string Author, string Category, string AvailabilityStatus, global::System.Nullable<int> PublishedYear, int Original_BookID, string Original_Title, string Original_Author, global::System.Nullable<int> Original_PublishedYear) {
            ...
            if ((AvailabilityStatus == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(AvailabilityStatus));
            }
            if ((PublishedYear.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(PublishedYear.Value));
            }
            else {
            ...
            if ((Original_PublishedYear.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((int)(Original_PublishedYear.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, string Author, string Category, string AvailabilityStatus, global::System.Nullable<int> PublishedYear, int Original_BookID, string Original_Title, string Original_Author, global::System.Nullable<int> Original_PublishedYear) {
            return this.Update(Original_BookID, Title, Author, Category, AvailabilityStatus, PublishedYear, Original_BookID, Original_Title, Original_Author, Original_PublishedYear);
        }
    }
